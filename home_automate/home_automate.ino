...
void set_appliance(String data){
  String relay1_state=String(digitalRead(RELAY1));
  String relay2_state=String(digitalRead(RELAY2));
  String relay3_state=String(digitalRead(RELAY3));
  String relay4_state=String(digitalRead(RELAY4));
  
  if(data.length()!=0){
    if(getValue(data,',',0)!=relay1_state){
    ...
    if(getValue(data,',',1)!=relay2_state){
      ...
      if(getValue(data,',',2)!=relay3_state){
      ...
      if(getValue(data,',',3)!=relay4_state){
